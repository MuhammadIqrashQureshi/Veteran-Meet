...
function Community (props){
	const handleSubmit = async (evt) => {
        ...
        data.followingCommunities.push(props.name);
	...
	<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
		...
		<div className="flex flex-col">
			<h2 className="text-lg font-semibold text-center md:text-left">{props.name}</h2>
			<p className="text-gray-600"><b>{props.about}</b></p>
			<p className="text-gray-600"><b>email </b>: {props.email}</p>
			<p className="text-gray-600"><b>followers </b>: {props.followers}</p>
			
		</div>
	</div>
	<div className="flex justify-center pt-4 space-x-4 align-center">
	<Link onClick={handleSubmit} className="mx-4 px-2 py-1 font-bold rounded bg-blue-400 text-gray-900 hover:bg-blue-800 hover:text-white">Follow</Link>
